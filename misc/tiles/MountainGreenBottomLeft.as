package tiles {
	...
	public class MountainGreenBottomLeft extends Sprite {

		
		public function MountainGreenBottomLeft(idX:int, idY:int) {
			
			addChild(Atlas.generate("mountain green bottom left"));
