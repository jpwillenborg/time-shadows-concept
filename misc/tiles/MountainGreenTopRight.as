package tiles {
	...
	public class MountainGreenTopRight extends Sprite {

		
		public function MountainGreenTopRight(idX:int, idY:int) {
			
			addChild(Atlas.generate("mountain green top right"));
