package tiles {
	...
	public class MountainGreenBottomRight extends Sprite {

		
		public function MountainGreenBottomRight(idX:int, idY:int) {
			
			addChild(Atlas.generate("mountain green bottom right"));
