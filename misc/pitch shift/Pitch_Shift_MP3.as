package
{
	...
	//
	// DURING YOUR GAME LOOP:
	//
	// (0.0=stop 0.5=half 1.0=normal 2.0=double)
	engine_loop.rate = my_current_speed/100;
	...
	*/
	...
	public class Pitch_Shift_MP3 
	{
		...
		public function Pitch_Shift_MP3(source_data:Class, skip_bytes_at_start:uint=0, skip_bytes_at_end:uint=0)
		{
